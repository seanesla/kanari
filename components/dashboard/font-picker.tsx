...
export function FontPicker() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <Label className="text-base">Body Font (Sans-serif)</Label>
      ...
      {/* Serif Font Selector */}
      <div>
        <Label className="text-base">Heading Font (Serif)</Label>
        <p className="text-sm text-muted-foreground mb-3">
      ...
      {/* Mono Font Selector */}
      <div>
        <Label className="text-base">Code Font (Monospace)</Label>
        <p className="text-sm text-muted-foreground mb-3">
