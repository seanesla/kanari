...
export function CheckInInputBar({ onStartNewCheckIn }: CheckInInputBarProps) {
  ...
  return (
    <div
      className="relative p-4 rounded-2xl border border-white/10 bg-[rgba(255,255,255,0.02)] backdrop-blur-2xl backdrop-saturate-200 group"
    ...
    >
      ...
      <button
        ...
        className="flex items-center gap-3 w-full max-w-2xl mx-auto px-4 py-3 rounded-xl border border-white/10 bg-[rgba(255,255,255,0.02)] text-left text-muted-foreground hover:border-white/20 hover:bg-[rgba(255,255,255,0.04)] transition-all"
      >
